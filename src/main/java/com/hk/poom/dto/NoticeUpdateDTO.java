...
public class NoticeUpdateDTO {
	...
	public String toString() {
		return "NoticeUpdateDTO [bno=" + bno + ", nno=" + nno + ", cat_n=" + cat_n + ", title=" + title
				+ ", mod_date_b=" + mod_date_b + ", img_n1=" + img_n1 + ", img_n2=" + img_n2 + ", img_n3=" + img_n3
				+ ", img_n4=" + img_n4 + ", img_n5=" + img_n5 + ", cont_b=" + cont_b + ", id_writer=" + id_writer
				+ ", img_chk=" + img_chk + "]";
	}
