...
public class RehomeUpdateDTO {
	...
	public String toString() {
		return "RehomeUpdateDTO [bno=" + bno + ", rno=" + rno + ", title=" + title + ", id_writer=" + id_writer
				+ ", img_r1=" + img_r1 + ", img_r2=" + img_r2 + ", img_r3=" + img_r3 + ", img_r4=" + img_r4
				+ ", img_r5=" + img_r5 + ", cat_r=" + cat_r + ", gender=" + gender + ", vac=" + vac + ", age=" + age
				+ ", nuet=" + nuet + ", cost=" + cost + ", cont_b=" + cont_b + ", mod_date_b=" + mod_date_b + "]";
	}
